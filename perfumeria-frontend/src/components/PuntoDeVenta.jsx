...
const PuntoDeVenta = () => {
  ...
  // Pestañas de venta: 'perfume', 'esencia', 'producto'
  const [tipoVentaTab, setTipoVentaTab] = useState('perfume');

  // Estados Perfume/Esencia
  ...
  useEffect(() => {
    ...
    fetch('https://perfumeria-final-b.onrender.com/productos')
      .then(res => res.json()).then(data => setProductosVarios(data)).catch(err => console.error("Error:", err));
  }, []);
